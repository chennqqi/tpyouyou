...
class cruise_orderModule extends BaseModule{
    ...
    function addform() {
        ...
        $tourline_total_price = intval($adult_price_total) + intval($child_price_total);
        ...
        $GLOBALS['tmpl']->assign("tourline_total_price",$tourline_total_price);
        ...
        $GLOBALS['tmpl']->display("cruise_order.html");
    }
    ...
    function submit_cart(){
        ...
        $tourline_total_price = intval($_POST['tourline_total_price']);
