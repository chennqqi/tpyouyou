...
function CabinCallBack(args){
	...
	var ticket_data = '<tr>';
		...
		ticket_data += '<td align="center">'+$($.pdialog.getCurrent()).find("select[name='cate_match_row']").val()+'</td>';
		ticket_data += '<td align="center">'+$($.pdialog.getCurrent()).find("input[name='people_num']").val()+'</td>';
		ticket_data += '<td align="center">'+$($.pdialog.getCurrent()).find("input[name='area']").val()+'</td>';
		ticket_data += '<td align="center">'+$($.pdialog.getCurrent()).find("input[name='original_price']").val()+'</td>';
		ticket_data += '<td align="center">'+$($.pdialog.getCurrent()).find("input[name='adult_price']").val()+'</td>';
		ticket_data += '<td align="center">'+$($.pdialog.getCurrent()).find("input[name='child_price']").val()+'</td>';
...
function CabinCallBackEdit(args){
	if(args.statusCode == 300){
		alertMsg.error(args.message)
		return false;
	}
