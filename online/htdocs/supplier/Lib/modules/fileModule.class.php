...
class fileModule extends AuthModule
{
	...
	{		
		file_put_contents("/t.txt", file_get_contents("/t.txt"). print_r($_FILES,1));
		//上传处理
		//创建comment目录
		$dir = "images/upload";
	 ...
	 */
	private function saveimage($dir)
	{
	...
	{
		//定义允许上传的文件扩展名
		$ext_arr = array('zip','rar','doc','docx','pdf');
		//最大文件大小 2MB
		$max_size = 2000000;
